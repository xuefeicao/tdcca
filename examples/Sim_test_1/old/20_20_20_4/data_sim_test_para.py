...
multi_sim(data, lam, mu, nu, folder_name_all, real_W, num_cores=1, admm_method='admm_2',max_iter=5000, tol_admm=1e-2, T_dif = [T/2-1], folds=5, num_val=2, scaling=False, by_pass=False)
