...
nu = [10**i for i in range(1)]
lam = [10**i for i in range(-4,5)] + [(10**i)*5 for i in range(-4,5)]
mu = [10**i for i in range(4)] 


# scaling, by_pass, pre_sign, with_sign, with_init 
multi_sim(data, lam, mu, nu, folder_name_all, real_W, num_cores=8, admm_method='admm_2',max_iter=5000, tol_admm=1e-4, T_dif = [T/2-1], folds=5, num_val=2, scaling=False, pre_sign=True, with_sign=True, by_pass=False, calculate_init=True)
